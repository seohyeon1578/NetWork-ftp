...
public class ServerThread extends Thread {
	...
	byte[] buf = null;
	private String filefolder = "D:\\UPLOAD\\";
	...
	public void FileSend(Protocol protocol, String fileName) {
		try {
			DataOutputStream dos = new DataOutputStream(this.os);
			BufferedOutputStream bos = new BufferedOutputStream(dos);
			
			File fl = new File(filefolder + fileName);
				...
				switch(packetType){
					...
					case Protocol.RES_DOWNLOAD :
						...
						if(dwName) {
							...
							FileSend(protocol, downloadFile);
						}else {
